...
\cdVariable{pah1}, \cdVariable{ph2n}, and \cdVariable{pn2c}. In the
\cdVariable{grey}, \cdVariable{pah1}, \cdVariable{ph2n}, and \cdVariable{ph2c}
...
$n=1$ for \cdVariable{exp1}, etc. Note that this size distribution extends
