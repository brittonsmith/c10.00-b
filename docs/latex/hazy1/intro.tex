...
H-like (\h0, \heplus, etc) and He-like (\he0, Li$^+$, etc)
...
\end{verbatim}
for system security.
The output will be in the file \cdFilename{simple.out}.
...
\cdFilename{tsuite/programs} directory of the download you obtain from the web site.
