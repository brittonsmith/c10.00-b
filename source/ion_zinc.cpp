...
void IonZinc(void)
{
	const int NDIM = ipZINC+1;

	static const double dicoef[2][NDIM] = {
		{1.41e-3,5.2e-3,.0138,.023,.0419,.0683,.122,.300,.15,.697,.709,.644,.525,.446,
		 .363,.302,.102,.27,.0467,.0835,.0996,.199,.24,.115,.0316,.803,.575,.575,.575,0.},
		{.469,.357,.281,.128,.0417,.0558,.0346,0.,1.9,.277,.135,.134,.192,.332,.337,.121,
		 .0514,.183,7.56,4.55,4.87,2.19,1.15,1.23,.132,.289,.286,.286,.286,0.}
	};
	static const double dite[2][NDIM] = {
		{9.82e4,2.01e5,3.05e5,4.20e5,5.56e5,6.72e5,7.93e5,9.00e5,1.00e6,7.81e5,7.64e5,
		 ...
		 1.23e6,3.32e5,6.45e5,6.65e7,6.81e7,6.81e7,6.81e7,0.},
		{1.01e5,1.91e5,2.32e5,3.18e5,4.55e5,5.51e5,5.28e5,0.,5.50e5,8.87e5,1.80e6,1.25e6,
		 ...
		 2.64e6,1.93e6,1.19e7,9.08e6,9.08e6,9.08e6,0.}
	};
	...
	ion_photo(ipZINC,false);

	/* find collisional ionization rates */
	ion_collis(ipZINC);

	/* get recombination coefficients */
	ion_recomb(false,(const double*)dicoef,(const double*)dite,ditcrt,aa,bb,cc,dd,ff,ipZINC);

	/* solve for ionization balance */
	ion_solver(ipZINC,false);
	return;
}
