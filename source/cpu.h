...
typedef enum { AS_DATA_ONLY_TRY, AS_DATA_LOCAL_TRY, AS_LOCAL_DATA_TRY, AS_LOCAL_ONLY_TRY,
	       AS_DATA_ONLY, AS_DATA_OPTIONAL, AS_DATA_LOCAL, AS_LOCAL_DATA, AS_LOCAL_ONLY } access_scheme;
...
#error "Please update g++ to a functional version."
#error "See http://wiki.nublado.org/wiki/CompilingCloudy for more details"
#endif
#endif
