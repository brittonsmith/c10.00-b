...
void PrtZone(void)
{
	...
	if( dense.lgElmtOn[ipHELIUM] )
	{
		...
		fprintf(ioQQQ,PrintEfmt("%9.2e", 
			StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2s3S].Pop/dense.gas_phase[ipHELIUM] ));
		...
		if( dense.lgElmtOn[ipHELIUM] )
		{
			...
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe1s1S].Pop*fac ));
			/* singlet n=2 complex */
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2s1S].Pop*fac ));
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2p1P].Pop*fac ));
			/* singlet n=3 complex */
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe3s1S].Pop*fac ));
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe3p1P].Pop*fac ));
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe3d1D].Pop*fac ));

			fprintf( ioQQQ, " He tripl" );
			/* triplet n=2 complex */
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2s3S].Pop*fac ));
			fprintf(ioQQQ,PrintEfmt("%9.2e", 
				StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2p3P0].Pop*fac+
				StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2p3P1].Pop*fac+
				StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe2p3P2].Pop*fac ));
			/* triplet n=3 complex */
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe3s3S].Pop*fac ));
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe3p3P].Pop*fac ));
			fprintf(ioQQQ,PrintEfmt("%9.2e", StatesElemNEW[ipHELIUM][ipHELIUM-ipHE_LIKE][ipHe3d3D].Pop*fac ));
			fprintf( ioQQQ, "\n" );
		}
	}
